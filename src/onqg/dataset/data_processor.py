...
def preprocess_batch(batch, n_edge_type, sparse=True, feature=False, dec_feature=0, 
    ...
    con = batch['con']
    con_seq, con_lengths = con[0], con[1]
    inputs['seq-encoder']['src_seq'], inputs['seq-encoder']['lengths'] = src_seq, lengths
    inputs['seq-encoder']['con_seq'], inputs['seq-encoder']['con_lengths'] = con_seq, con_lengths
    ###===== encoder transform =====###
    ...
    graph_index, index_cross, index_lengths ,index_node_lengths= graph_index[0], graph_index[1], graph_index[2], graph_index[3]
    ...
    inputs['encoder-transform']['node_lengths'] = index_node_lengths
    inputs['encoder-transform']['cross_lengths'] = index_cross

    #graph_index = batch['graph_index']
    # graph_root = batch['graph_root']
    #graph_index, index_lengths = graph_index[0], graph_index[1]
    #inputs['encoder-transform']['index'], inputs['encoder-transform']['lengths'] = nodes, index_lengths
    #inputs['encoder-transform']['index'], inputs['encoder-transform']['lengths'] = graph_index, index_lengths
    # inputs['encoder-transform']['root'] = graph_root
    ...
    return inputs, (max_node_num, max_node_size), generation, (copy_gold, copy_switch)
