...
def add_options(parser):
    ...
    parser.add_argument('-train_user', help="Path to the training user profile data")
    parser.add_argument('-train_kno', help="Path to the training knowledge data")
    parser.add_argument('-train_con', help="Path to the training context data")

    parser.add_argument('-valid_kno', help="Path to the valid knowledge data")
    parser.add_argument('-valid_user', help="Path to the valid user profile data")
    ...
    parser.add_argument('-valid_con', help="Path to the valid context data")
    ...
    parser.add_argument('-train_know_graph', help="Path to the training source graph data")
    parser.add_argument('-valid_know_graph', help="Path to the validation source graph data")
